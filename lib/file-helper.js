...
exports.PackagesComponentList = fs.readdirSync(configPaths.components).filter(file => (file !== 'all' && file !== 'globals' && file !== 'icons'))
...
const expectedDistFilesForComponent = componentName => {
  ...
  let srcComponentFiles = fs.readdirSync(configPaths.components + componentName)
