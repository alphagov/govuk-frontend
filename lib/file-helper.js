...
exports.PackagesCount = fs.readdirSync(configPaths.govukFrontend).filter(file => (file !== 'all' && file !== 'globals' && file !== 'icons'))
...
const expectedDistFilesForComponent = componentName => {
  ...
  let srcComponentFiles = fs.readdirSync(configPaths.govukFrontend + componentName)
