 ...
 * @param {String} children any child components or text, pass the children to the macro
 * @returns {String} HTML rendered by the macro
 */
function renderHtml (componentName, params, children = false) {
 ...
 * @param {Object} params parameters that are used in the component macro
 * @param {String} children any child components or text, pass the children to the macro
 * @returns {CheerioAPI} returns cheerio (jQuery) instance of the macro for easy DOM querying
 */
function render (componentName, params, children = false) {
  return cheerio.load(
    renderHtml(componentName, params, children)
  )
}
