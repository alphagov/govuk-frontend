 ...
 * Render Sass String
 *
 * @param {string} sassString the string to compile
 * @param {object} options Options to pass to sass.compileString
 * @return {promise} Result of calling sass.compileString
 */
function renderSassString (sassString, options) {
  return sassRender({
    data: sassString,
 ...
 * Render Sass File
 *
 * @param {string} sassFilePath the file to compile
 * @param {object} options Options to pass to sass.compileString
 * @return {promise} Result of calling sass.compileString
 */
function renderSassFile (sassString, options) {
  return sassRender({
    file: sassString,
    includePaths: [configPaths.src],
    ...(options || {})
