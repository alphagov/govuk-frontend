...
describe('Checkboxes', () => {
  ...
  it('render example with minimum required name and items', () => {
    ...
    const $firstInput = $component.find('.moaland-checkboxes__item:first-child input')
    const $firstLabel = $component.find('.moaland-checkboxes__item:first-child label')
    ...
    const $lastInput = $component.find('.moaland-checkboxes__item:last-child input')
    const $lastLabel = $component.find('.moaland-checkboxes__item:last-child label')
  ...
  it('render example without falsely values', () => {
    ...
    const $component = $('.moaland-checkboxes')
    const $items = $component.find('.moaland-checkboxes__item')
  ...
  it('render additional label classes', () => {
    ...
    const $component = $('.moaland-checkboxes')
    const $label = $component.find('.moaland-checkboxes__item label')
  ...
  describe('items', () => {
    ...
    it('render disabled', () => {
      ...
      const $disabledInput = $component.find('.moaland-checkboxes__item:last-child input')
    ...
    it('render checked', () => {
      ...
      const $component = $('.moaland-checkboxes')
      const $secondInput = $component.find('.moaland-checkboxes__item:nth-child(2) input')
      const $lastInput = $component.find('.moaland-checkboxes__item:last-child input')
  ...
  describe('when they include a hint', () => {
    it('it renders the hint text', () => {
      ...
      const $firstHint = $('.moaland-checkboxes__hint').first()
    ...
    it('it renders the correct id attribute for the hint', () => {
      ...
      expect($('.moaland-checkboxes__hint').attr('id')).toBe('government-gateway-item-hint')
    })

    it('the input describedBy attribute matches the item hint id', () => {
      const $ = render('checkboxes', examples['with hints on items'])

      expect($('.moaland-checkboxes__input').attr('aria-describedby')).toBe('government-gateway-item-hint')
    })
  })
  ...
  describe('render conditionals', () => {
    it('hidden by default when not checked', () => {
      ...
      const $firstConditional = $component.find('.moaland-checkboxes__conditional').first()
      expect($firstConditional.text().trim()).toContain('Email address')
      expect($firstConditional.hasClass('moaland-checkboxes__conditional--hidden')).toBeTruthy()
    })
    it('visible by default when checked', () => {
      ...
      const $firstConditional = $component.find('.moaland-checkboxes__conditional').first()
      expect($firstConditional.text().trim()).toContain('Email address')
      expect($firstConditional.hasClass('moaland-checkboxes__conditional--hidden')).toBeFalsy()
    })
    ...
    it('with association to the input they are controlled by', () => {
      ...
      const $lastInput = $component.find('.moaland-checkboxes__input').last()
      const $lastConditional = $component.find('.moaland-checkboxes__conditional').last()
    ...
    it('omits empty conditionals', () => {
      ...
      const $component = $('.moaland-checkboxes')
      expect($component.find('.moaland-checkboxes__conditional').length).toEqual(0)
    })

    it('does not associate checkboxes with empty conditionals', () => {
      const $ = render('checkboxes', examples['empty conditional'])

      const $input = $('.moaland-checkboxes__input').first()
  ...
  describe('nested dependant components', () => {
    it('have correct nesting order', () => {
      ...
      const $component = $('.moaland-form-group > .moaland-fieldset > .moaland-checkboxes')
    ...
    it('passes through label params without breaking', () => {
      ...
      expect(htmlWithClassName($, '.moaland-checkboxes__label')).toMatchSnapshot()
    })
