...
describe('Panel', () => {
  describe('default example', () => {
    ...
    it('renders title text', () => {
      const $ = render('panel', examples.default)
      const panelTitle = $('.moaland-panel__title').text().trim()
    ...
    it('renders title as h1 (as the default heading level)', () => {
      const $ = render('panel', examples.default)
      const panelTitleHeadingLevel = $('.moaland-panel__title')[0].name
    ...
    it('renders body text', () => {
      const $ = render('panel', examples.default)
      const panelBodyText = $('.moaland-panel__body').text().trim()
    ...
    it('doesnt render panel body if no body text is passed', () => {
      ...
      const panelBody = $('.moaland-panel__body').length
  ...
  describe('custom options', () => {
    it('allows title text to be passed whilst escaping HTML entities', () => {
      ...
      const panelTitle = $('.moaland-panel__title').html().trim()
    ...
    it('allows body text to be passed whilst escaping HTML entities', () => {
      ...
      const panelBodyText = $('.moaland-panel__body').html().trim()
