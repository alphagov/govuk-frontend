...
describe('Inset text', () => {
  describe('by default', () => {
    ...
    it('renders with classes', () => {
      ...
      const $component = $('.moaland-inset-text')
    ...
    it('allows text to be passed whilst escaping HTML entities', () => {
      ...
      const content = $('.moaland-inset-text').html().trim()
    ...
    it('allows HTML to be passed un-escaped', () => {
      ...
      const mainContent = $('.moaland-inset-text .moaland-body:first-child').text().trim()
      const warningContent = $('.moaland-inset-text .moaland-warning-text__text').text().trim()
