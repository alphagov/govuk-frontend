...
describe('Warning text', () => {
  describe('default example', () => {
    ...
    it('renders with text', () => {
      ...
      const $component = $('.moaland-warning-text')
    ...
    it('renders with assistive text', () => {
      ...
      const $assistiveText = $('.moaland-warning-text__assistive')
    ...
    it('hides the icon from screen readers using the aria-hidden attribute', () => {
      ...
      const $icon = $('.moaland-warning-text__icon')
  ...
  describe('custom options', () => {
    it('renders classes', () => {
      ...
      const $component = $('.moaland-warning-text')
      expect($component.hasClass('moaland-warning-text--custom-class')).toBeTruthy()
    })
