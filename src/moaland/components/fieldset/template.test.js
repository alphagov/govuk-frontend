...
describe('fieldset', () => {
  ...
  it('creates a fieldset', () => {
    ...
    const $component = $('fieldset.moaland-fieldset')
  ...
  it('includes a legend element which captions the fieldset', () => {
    ...
    const $legend = $('.moaland-fieldset__legend')
  ...
  it('allows you to set the aria-describedby attribute', () => {
    ...
    const $component = $('.moaland-fieldset')
  ...
  it('nests the legend text in an H1 if the legend is a page heading', () => {
    ...
    const $headingInsideLegend = $('.moaland-fieldset__legend > h1')
  ...
  it('renders html when passed as fieldset content', () => {
    ...
    expect($('.moaland-fieldset .my-content').text().trim()).toEqual('This is some content to put inside the fieldset')
  })

  it('renders nested components using `call`', () => {
    const $ = render('fieldset', {}, '<div class="app-nested-component"></div>')

    expect($('.moaland-fieldset .app-nested-component').length).toBeTruthy()
  })
