...
describe('Textarea', () => {
  describe('default example', () => {
    ...
    it('renders with id', () => {
      ...
      const $component = $('.moaland-textarea')
  ...
  describe('when it includes a hint', () => {
    ...
    it('associates the textarea as "described by" the hint', () => {
      ...
      const $textarea = $('.moaland-textarea')
  ...
  describe('with dependant components', () => {
    it('have correct nesting order', () => {
      ...
      const $component = $('.moaland-form-group > .moaland-textarea')
    ...
    it('renders label as page heading', () => {
      ...
      const $label = $('.moaland-label')
      expect($('.moaland-label-wrapper')).toBeTruthy()
