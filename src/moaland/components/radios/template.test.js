...
describe('Radios', () => {
  ...
  it('render example with minimum required name and items', () => {
    ...
    const $component = $('.moaland-radios')

    const $firstInput = $component.find('.moaland-radios__item:first-child input')
    const $firstLabel = $component.find('.moaland-radios__item:first-child label')
    expect($firstInput.attr('name')).toEqual('example-default')
    expect($firstInput.val()).toEqual('yes')
    expect($firstLabel.text()).toContain('Yes')

    const $lastInput = $component.find('.moaland-radios__item:last-child input')
    const $lastLabel = $component.find('.moaland-radios__item:last-child label')
  ...
  it('renders without falsely items', () => {
    ...
    const $component = $('.moaland-radios')
    const $items = $component.find('.moaland-radios__item input')
  ...
  it('render classes', () => {
    ...
    expect($component.hasClass('moaland-radios--inline')).toBeTruthy()
  })
  ...
  describe('items', () => {
    ...
    describe('when they include a hint', () => {
      it('it renders the hint text', () => {
        ...
        expect($('.moaland-radios__hint').text())
      ...
      it('it renders the correct id attribute for the hint', () => {
        ...
        expect($('.moaland-radios__hint').attr('id')).toBe('gateway-item-hint')
      })

      it('the input describedBy attribute matches the item hint id', () => {
        const $ = render('radios', examples['with hints on items'])

        expect($('.moaland-radios__input').attr('aria-describedby')).toBe('gateway-item-hint')
      })
    })
    ...
    describe('render conditionals', () => {
      it('hidden by default when not checked', () => {
        ...
        const $hiddenConditional = $component.find('.moaland-radios__conditional').first()
        expect($hiddenConditional.text()).toContain('Email address')
        expect($hiddenConditional.hasClass('moaland-radios__conditional--hidden')).toBeTruthy()
      })
      ...
      it('visible by default when checked', () => {
        ...
        const $visibleConditional = $component.find('.moaland-radios__conditional').first()
        expect($visibleConditional.text()).toContain('Email')
        expect($visibleConditional.hasClass('moaland-radios__conditional--hidden')).toBeFalsy()
      })
      ...
      it('with association to the input they are controlled by', () => {
        ...
        const $firstInput = $component.find('.moaland-radios__input').first()
        const $firstConditional = $component.find('.moaland-radios__conditional').first()
      ...
      it('omits empty conditionals', () => {
        ...
        const $component = $('.moaland-radios')
        expect($component.find('.moaland-radios__conditional').length).toEqual(0)
      })

      it('does not associate radios with empty conditionals', () => {
        const $ = render('radios', examples['with empty conditional'])

        const $input = $('.moaland-radios__input').first()
    ...
    it('render divider', () => {
      ...
      const $component = $('.moaland-radios')
      const $divider = $component.find('.moaland-radios__divider')
    ...
    it('render additional label classes', () => {
      ...
      const $component = $('.moaland-radios')
      const $label = $component.find('.moaland-radios__item label')
  ...
  describe('nested dependant components', () => {
    it('have correct nesting order', () => {
      ...
      const $component = $('.moaland-form-group > .moaland-fieldset > .moaland-radios')
    ...
    it('passes through label params without breaking', () => {
      ...
      expect(htmlWithClassName($, '.moaland-radios__label')).toMatchSnapshot()
    })
