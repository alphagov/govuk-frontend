...
describe('Breadcrumbs', () => {
  describe('default example', () => {
    ...
    it('renders with items', () => {
      ...
      const $items = $('.moaland-breadcrumbs__list-item')
    ...
    it('renders item with anchor', () => {
      ...
      const $anchor = $('.moaland-breadcrumbs__list-item a').first()
      expect($anchor.get(0).tagName).toEqual('a')
      expect($anchor.attr('class')).toEqual('moaland-breadcrumbs__link')
  ...
  describe('custom options', () => {
    it('renders item with text', () => {
      ...
      const $item = $('.moaland-breadcrumbs__list-item').last()
    ...
    it('renders item with escaped entities in text', () => {
      ...
      const $item = $('.moaland-breadcrumbs__list-item')
    ...
    it('renders item with html', () => {
      ...
      const $item = $('.moaland-breadcrumbs__list-item').first()
    ...
    it('renders item with html inside anchor', () => {
      ...
      const $anchor = $('.moaland-breadcrumbs__list-item a').last()
    ...
    it('renders item anchor with attributes', () => {
      ...
      const $breadcrumbLink = $('.moaland-breadcrumbs__link')
    ...
    it('renders with classes', () => {
      ...
      const $component = $('.moaland-breadcrumbs')
    ...
    it('renders item as collapse on mobile if specified', () => {
      ...
      const $component = $('.moaland-breadcrumbs')
      expect($component.hasClass('moaland-breadcrumbs--collapse-on-mobile')).toBeTruthy()
    })
  })
})
