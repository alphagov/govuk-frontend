...
describe('footer', () => {
  ...
  it('renders custom container classes', () => {
    ...
    const $component = $('.moaland-footer')
    const $container = $component.find('.moaland-width-container')
  ...
  describe('meta', () => {
    ...
    it('renders heading', () => {
      ...
      const $component = $('.moaland-footer')
      const $heading = $component.find('h2.moaland-visually-hidden')
    ...
    it('doesn\'t render footer link list when no items are provided', () => {
      ...
      const $component = $('.moaland-footer')
      expect($component.find('.moaland-footer__inline-list').length).toEqual(0)
    })
    ...
    it('renders links', () => {
      ...
      const $component = $('.moaland-footer')
      const $list = $component.find('ul.moaland-footer__inline-list')
      const $items = $list.find('li.moaland-footer__inline-list-item')
      const $firstItem = $items.find('a.moaland-footer__link:first-child')
    ...
    it('renders attributes on meta links', () => {
      ...
      const $metaLink = $('.moaland-footer__meta .moaland-footer__link')
  ...
  describe('navigation', () => {
    ...
    it('no items displayed when no item array is provided', () => {
      ...
      const $component = $('.moaland-footer')
      expect($component.find('.moaland-footer__navigation').length).toEqual(0)
    })
    ...
    it('renders headings', () => {
      ...
      const $component = $('.moaland-footer')
      const $firstSection = $component.find('.moaland-footer__section:first-child')
      const $lastSection = $component.find('.moaland-footer__section:last-child')
      const $firstHeading = $firstSection.find('h2.moaland-footer__heading')
      const $lastHeading = $lastSection.find('h2.moaland-footer__heading')
    ...
    it('renders lists of links', () => {
      ...
      const $component = $('.moaland-footer')
      const $list = $component.find('ul.moaland-footer__list')
      const $items = $list.find('li.moaland-footer__list-item')
      const $firstItem = $items.find('a.moaland-footer__link:first-child')
    ...
    it('renders attributes on links', () => {
      ...
      const $navigationLink = $('.moaland-footer__list .moaland-footer__link')
    ...
    it('renders lists in columns', () => {
      ...
      const $component = $('.moaland-footer')
      const $list = $component.find('ul.moaland-footer__list')
      expect($list.hasClass('moaland-footer__list--columns-2')).toBeTruthy()
    })
  })
  ...
  describe('section break', () => {
    it('renders when there is a navigation', () => {
      ...
      const $component = $('.moaland-footer')
      const $sectionBreak = $component.find('hr.moaland-footer__section-break')
