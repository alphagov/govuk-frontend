...
describe('Error-summary', () => {
  describe('default example', () => {
    ...
    it('aria-labelledby attribute matches the title id', () => {
      const $ = render('error-summary', examples.default)
      const ariaAttr = $('.moaland-error-summary').attr('aria-labelledby')
    ...
    it('has role=alert attribute', () => {
      const $ = render('error-summary', examples.default)
      const roleAttr = $('.moaland-error-summary').attr('role')
    ...
    it('has the correct tabindex attribute to be focussed', () => {
      const $ = render('error-summary', examples.default)
      const tabindexAttr = $('.moaland-error-summary').attr('tabindex')
    ...
    it('renders title text', () => {
      const $ = render('error-summary', examples.default)
      const summaryTitle = $('.moaland-error-summary__title').text().trim()
    ...
    it('number of error items matches the number of items specified', () => {
      const $ = render('error-summary', examples.default)
      const errorList = $('.moaland-error-summary .moaland-error-summary__list li')
    ...
    it('error list item is an anchor tag if href attribute is specified', () => {
      ...
      const errorItem = $('.moaland-error-summary .moaland-error-summary__list li:first-child')
    ...
    it('render anchor tag href attribute is correctly', () => {
      ...
      const errorItem = $('.moaland-error-summary .moaland-error-summary__list li:first-child a')
  ...
  describe('custom options', () => {
    it('allows title text to be passed whilst escaping HTML entities', () => {
      ...
      const summaryTitle = $('.moaland-error-summary__title').html().trim()
    ...
    it('renders description text', () => {
      ...
      const summaryDescription = $('.moaland-error-summary__body p').text().trim()
    ...
    it('allows description text to be passed whilst escaping HTML entities', () => {
      ...
      const summaryDescription = $('.moaland-error-summary__body p').html().trim()
    ...
    it('allows additional classes to be added to the error-summary component', () => {
      ...
      const $component = $('.moaland-error-summary')
    ...
    it('renders anchor tag with attributes', () => {
      ...
      const $component = $('.moaland-error-summary__list a')
    ...
    it('renders error item text', () => {
      ...
      const errorItemText = $('.moaland-error-summary .moaland-error-summary__list li:first-child').text().trim()
    ...
    it('allows error item HTML to be passed un-escaped', () => {
      ...
      const errorItemText = $('.moaland-error-summary .moaland-error-summary__list li').html().trim()
    ...
    it('allows error item HTML inside "a" tag to be passed un-escaped', () => {
      ...
      const errorItemText = $('.moaland-error-summary .moaland-error-summary__list li a').html().trim()
