 ...
 * @property {number|string} size - File size, either in readable format or as number
 * @property {('bundled'|'minified')} [type] - Type of file size. Only used by module sizes
 * @property {string} [percentage] - Percentage change between base and head of a particular file
 */
