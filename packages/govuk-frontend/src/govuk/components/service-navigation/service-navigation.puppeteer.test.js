...
describe('/components/service-navigation', () => {
  ...
  describe('/components/service-navigation/with-navigation', () => {
    describe('when JavaScript is unavailable or fails', () => {
      beforeAll(async () => {
        await page.setJavaScriptEnabled(false)
        await render(page, 'service-navigation', examples['with navigation'])
      })
    ...
    describe('when JavaScript is available', () => {
      ...
      describe('errors at instantiation', () => {
        ...
        it("throws when the toggle's aria-control attribute is missing", async () => {
          await expect(
            render(page, 'service-navigation', examples['with navigation'], {
