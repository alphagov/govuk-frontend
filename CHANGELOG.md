...
Support for Ruby Sass ended in 2019 and LibSass was deprecated in 2020. A number of Sass implementations—including Node Sass, SassC and sass-rs—are dependent upon LibSass. These are also no longer supported by GOV.UK Frontend.
