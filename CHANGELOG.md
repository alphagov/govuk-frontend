...
If you were redefining a custom value for the applied colour before importing GOV.UK Frontend, you can still do so by assigning a map of the colours you want to change to the `$govuk-applied-colours` variable.
...
Note that you can only redefine existing applied colours, not add new applied colours. This is to ensure a clear separation between colours from GOV.UK Frontend and colours from your own project.
