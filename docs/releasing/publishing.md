...
6. Update the [`CHANGELOG.md`](/CHANGELOG.md) by:
   ...
   - adding, after the 'Unreleased' heading, a new heading with the version number and release type (`## <VERSION_NUMBER> (<RELEASE_TYPE>)`). For example, '## 3.11.0 (Feature release)'
   - saving your changes
