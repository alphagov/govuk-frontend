...
For example, if you updated a mixin in [`package/src/govuk/helpers/_colour.scss`](/package/src/govuk/helpers/_colour.scss), update or add tests in [`package/src/govuk/helpers/colour.test.js`](/package/src/govuk/helpers/colour.test.js).
...
npm link ../govuk-frontend/package/dist/
```

When you've finished testing, run this command to unlink the package:

```bash
npm unlink ../govuk-frontend/package/dist/
```
