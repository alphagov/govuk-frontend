...
You can read more about how `$govuk-suppressed-warnings` and `_warning` work by reading their respective sassdocs in [`package/src/govuk/settings/_warnings.scss`](/package/src/govuk/settings/_warnings.scss).
