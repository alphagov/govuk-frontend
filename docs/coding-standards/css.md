...
by basing our folder structure and naming based on the following layers:
...
This layer:
- forms part of the @govuk-frontend/global package.
- uses the prefix `govuk-h-` for its classes.
...
This layer:
- forms part of the @govuk-frontend/global package.
- uses the simpler prefix `govuk-` for its classes.
...
This layer:
- forms part of the @govuk-frontend/global package.
- uses the prefix `govuk-o-` for its classes.
...
- is distributed as individual packages within the @govuk-frontend scope for
  each component.
- uses the prefix `govuk-c-` for its classes.

Any classes generated by this layer will use the prefix `govuk-c-`.
